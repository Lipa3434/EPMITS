...
namespace EPMITS.Controllers
{
    public class MedicationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Dosage")] Medication medication)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Dosage")] Medication medication)
        {
            if (id != medication.Id)
            {
                return NotFound();
